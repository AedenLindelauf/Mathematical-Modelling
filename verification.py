...
def consists_of_valid_characters(expression : str, raise_error : bool = False) -> bool:
    ...
    if raise_error:
        ...
        raise InvalidCharacterError("Invalid character entered")
...
def has_consecutive_operators(expression : str, raise_error : bool = False) -> bool:
    ...
    if raise_error:
        raise OperatorPlacementError("Cannot have two operators consecutively")
...
def has_operator_after_parenthesis(expression : str, raise_error : bool = False):
    ...
    if raise_error:
        raise OperatorPlacementError("Cannot have these operators right after a opening parenthesis")
